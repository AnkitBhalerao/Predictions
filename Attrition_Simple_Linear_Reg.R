...
pred = predict(empdata1lm5,newdata=data.frame(Age=c(20,30,40,50,60),
                                      MonthlyIncome=c(2500,10000,20000,50000,100000),
                                      PercentSalaryHike=c(10,20,30,40,50),
                                      WorkLifeBalance=c(1,2,3,4,5),
                                      JobSatisfaction=c(1,2,3,4,5)))
pred
plot(pred) 